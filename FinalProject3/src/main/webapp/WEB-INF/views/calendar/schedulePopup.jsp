...
<body> 
	<div class = "group" id = "popupGroup"> 
		<div class = "group-head"> 
			<h1 style="	margin-left: 5px;"> 일정 추가 </h1>
			<hr>
		</div> 
		...
		<div class = "group-body"> 
				...
				<form name = "scheduleData">
					...
					<div class = "domain"> 
				 	...
				 	<div class = "top"> 
				 		<input class = "subject" id = "calsubject" type = "text" name = "calsubject" placeholder="제목을 입력해주세요"> 
				 	</div> 
				 	...
				 	<div class = "domain"> 
				 	 ...
				 	 <div class = "domain"> 
				 	  <textarea class = "memo" id = "memo" name = "memo" rows = "5" cols = "51" placeholder="100글자까지 입력 가능합니다"></textarea> 
				 	  </div>
				 	      <input type="hidden" name="fk_perno" value="${sessionScope.loginuser.perno}"/>
				 </form>
				 <div id="div_btnOk" align="center">
			   		<button type="button" id="ok" onclick="click_ok();">추가</button>
